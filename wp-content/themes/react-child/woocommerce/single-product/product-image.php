...
?>
<div class="swiper-single-product-container swiper-top-single">
	<div class="swiper-wrapper">
		...
		if ( has_post_thumbnail() ) {
			...
			$html .= '<img alt="" src="'. get_the_post_thumbnail_url( $post->ID, 'full' ).'">';
			$html .= '</div>';
		} else {
...
<div class="gallery-thumb-container clearfix">
