...
function iphorm_activate()
{
    ...
    add_option('iphorm_disable_uniform_output', 0);
    add_option('iphorm_disable_fileupload_output', 0);
...
function iphorm_uninstall()
{
    ...
    delete_option('iphorm_disable_uniform_output');
    delete_option('iphorm_disable_fileupload_output');
        ...
        if (isset($_GET['action']) && $_GET['action'] == 'entry') {
            ...
            if ($id > 0) {
                ...
                if (isset($_GET['action'])) {
                    ...
                    } else if ($_GET['action'] == 'delete' && current_user_can('iphorm_delete_entry')) {
                        $entryId = isset($_GET['entry_id']) ? absint($_GET['entry_id']) : 0;
...
{
    if ($action != 'plugin_information' || !isset($args->slug) || $args->slug != IPHORM_PLUGIN_NAME) {
        return $false;
    }
...
<div class="iphorm-global-nav-wrap qfb-cf">
    <ul class="iphorm-global-nav-ul">
        ...
        <?php endif; ?>
        <?php if (current_user_can('iphorm_import')) : ?>
        ...
        <?php endif; ?>
        <?php if (current_user_can('iphorm_settings')) : ?>
        ...
        <?php endif; ?>
        <?php if (current_user_can('iphorm_help')) : ?>
