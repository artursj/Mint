        ...
        <div class="ifb-element-settings-tabs" id="ifb-element-settings-tabs-<?php echo $id; ?>">
            ...
            <div class="ifb-tabs-panel" id="ifb-element-settings-tab-more-<?php echo $id; ?>">
                ...
                <table class="ifb-form-table ifb-element-settings-form-table ifb-element-settings-more-form-table">
                    ...
                    <tr valign="top">
                        <th scope="row"><label for="enable_swf_upload_<?php echo $id; ?>"><?php esc_html_e('Enable enhanced uploader', 'iphorm'); ?></label></th>
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('Enables the enhanced file uploader which shows the progress of file uploads, for modern browsers that support it.', 'iphorm'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr valign="top" class="<?php if (!$element['allow_multiple_uploads']) echo 'ifb-hidden'; ?> show-if-allow-multiple-uploads">
                        <th scope="row">
                            <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                <?php esc_html_e('If you are using the enhanced uploader the user will only ever see one field, but they will be able to queue as many files as they want.', 'iphorm'); ?>
                            </div></div>
                    ...
                    <tr valign="top" class="<?php if (!$element['allow_multiple_uploads']) echo 'ifb-hidden'; ?> show-if-allow-multiple-uploads">
                        <th scope="row">
                            <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                <?php esc_html_e('This will not appear if you are using the enhanced uploader, as the user can queue as many files as they want.', 'iphorm'); ?>
                            </div></div>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p class="description"><?php printf(esc_html__('Override the text for the browse button which is "%s", this only applies if you are using Uniform or the enhanced uploader', 'iphorm'), _x('Browse...', 'for a file to upload', 'iphorm')); ?></p>
                        </td>
                    </tr>
