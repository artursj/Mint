<?php if (!defined('IPHORM_VERSION')) exit; ?><h4>Enable enhanced uploader<a class="iphorm-help-anchor" id="enable-swf" name="enable-swf"></a></h4>
<p>Enables the enhanced file upload functionality, which shows the progress of file uploads
when the form is submitted. Uncheck to use normal web browser file uploading. Note: users with older web browsers that do not support file uploads over XHR
will not be able to use this and they will see a normal web browser file upload field.</p>
...
If you have the enhanced uploader enabled then the user can upload as many files as they want. For
...
<p>How many file upload fields to show. If you have enabled the enhanced uploader, you can upload more
than one file using one upload field so only one upload field is shown. For users with browsers that do
not support the enhanced uploader, or if you have disabled it here, they will see this number of upload fields.</p>
...
to add more upload fields to upload more files. If you have enabled the enhanced uploader, this
will not appear for users with support for the enhanced uploader. For users with JavaScript enabled, the link will be shown.</p>
...
if using the enhanced uploader or Uniform is enabled.</p>

<h4>Default text</h4>
<p>Specify the default text for the file upload input. This is only shown when the enhanced
uploader is disabled and Uniform is enabled (since the enhanced uploader replaces the
file input) or if the user's browser does not support the enhanced uploader but JavaScript is enabled.</p>
