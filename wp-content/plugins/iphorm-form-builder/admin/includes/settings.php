<?php if (!defined('IPHORM_VERSION')) exit; ?><div class="wrap">
    ...
    <?php if (isset($_POST['iphorm_settings'])) : ?>
        <?php
            ...
            update_option('iphorm_disable_fileupload_output', isset($_POST['disable_fileupload_output']) && $_POST['disable_fileupload_output'] == 1);
    ...
    <form method="post" action="">
        ...
        <p><label class="ifb-bold"><input type="checkbox" value="1" name="disable_fileupload_output" id="disable_fileupload_output" <?php checked(true, get_option('iphorm_disable_fileupload_output')); ?> /> <?php esc_html_e('Disable jQuery File Upload output', 'iphorm'); ?></label></p>
