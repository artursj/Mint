...
if ( isset( $portfolio['style'] ) && !empty( $portfolio['style'] ) && $styles[$portfolio['style']]['data'] ) {
	...
	if ( $css_prop ) { echo sprintf( '%1$s .gw-gopf-post-media-wrap img { %2$s }', $id_prefix, $css_prop ) . "\n"; }
	if ( $css_prop2 ) { echo sprintf( '%1$s .gw-gopf-post-media-wrap { %2$s }', $id_prefix, $css_prop2 ) . "\n"; }
