 ...
 */
class TCW_Widget_Popular extends WP_Widget
{
	/**
	...
	{
		$this->defaults = array(
			'title' => sanitize_text_field(esc_html__('Popular Posts', 'react-widgets')),
			'count' => 5,
			'show_thumbnail' => true,
		...
		$widget_ops = array('classname' => 'tcw-widget-popular', 'description' => esc_html__('Your site&#8217;s most popular Posts.', 'react-widgets'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('tcw-widget-popular', 'React - ' . esc_html__('Popular Posts', 'react-widgets'), $widget_ops, $control_ops);
	}
	...
	public function widget($args, $instance)
	{
		...
		if (function_exists('icl_t')) {
			$instance['title'] = icl_t('React Widgets', 'Popular Posts Title - '  . $this->id, $instance['title']);
		}
		...
		if ($items->have_posts()) :
			...
			?>
			<div class="tcw-widget-popular-inner">
	...
	public function update($new_instance, $old_instance)
	{
		...
		if (function_exists('icl_register_string')) {
			icl_register_string('React Widgets', 'Popular Posts Title - ' . $this->id, $instance['title']);
		}
